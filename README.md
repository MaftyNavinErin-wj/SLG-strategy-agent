...
- `context/slg_internal_taxonomy_2x2.md`: working 2x2 for SLG internal experience structure: geo constraint / territory continuity vs synchronous battlefield operation, with casualization as an overlay.
